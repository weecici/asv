...
def main(args: argparse.Namespace) -> None:
    ...
    if args.predict:
        if not args.audio_file:
            raise ValueError("For prediction, --audio_file must be provided")

        result = predict(args.audio_file, args.config)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--predict", action="store_true", help="Run prediction on audio file"
    )
    parser.add_argument(
        "--audio_file", type=str, help="Path to audio file for prediction"
    )
